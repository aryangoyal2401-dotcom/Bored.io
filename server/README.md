# Sahayak — Server (Express / Local Dev)

## Overview
Backend server for local development. In production, this is replaced by AWS Lambda functions.

## Purpose
- **Local Development:** Test API endpoints before deploying to Lambda
- **Quick Prototyping:** Rapid iteration during development
