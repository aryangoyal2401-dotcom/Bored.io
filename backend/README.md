# Sahayak — Backend (AWS Lambda / Serverless)

## Overview
Serverless backend for **Sahayak** using AWS Lambda functions.
...
Store your Gemini API Key in a `.env` file or use AWS Secrets Manager.
...
For production, use AWS Secrets Manager or Lambda environment variables.
