...
class StorageService:
    ...
    def __init__(self, base_dir: str = None):
        if not base_dir:
            base_dir = os.environ.get('DATA_DIR', os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "data"))
        self.base_dir = base_dir
        self.patients_file = os.path.join(base_dir, "patients.json")
        self.queue_file = os.path.join(base_dir, "queue.json")
    ...
    def get_queue(self) -> List[Dict]:
        ...
        data = self.load_json(self.queue_file)
