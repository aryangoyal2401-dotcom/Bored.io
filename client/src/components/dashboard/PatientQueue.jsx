    ...
    return (
      ...
      >
        ...
        <div className="space-y-2">
          ...
          {/* Line 2: Full UHID & Intake Badges */}
          <div className="flex items-center justify-between text-xs ml-8">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              {/* Emergency Red Flag Badge */}
              {(patient.priority === 'emergency_stat' || patient.hasRedFlags) && (
              ...
              <span className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-slate-800 text-slate-300 border border-slate-700">
                {patient.intakeMode === 'kiosk_self_service' ? '🖥️ MediKiosk' : '👩‍⚕️ Nurse Assisted'}
              </span>
            </div>
          </div>
        </div>
