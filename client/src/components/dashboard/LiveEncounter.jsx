      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-6 space-y-6">
          ...
          >
            ...
            {/* Structured 8-Section Clinical Summary OR Legacy SOAP Note */}
            {liveEncounterData.structuredClinicalSummary ? (
              <StructuredClinicalSummaryView
                encounterData={liveEncounterData}
                patient={selectedPatient}
                colors={colors}
                onReviewUpdate={(status) => {
                  console.log('Physician review status updated:', status);
                }}
              />
            ) : (
            <div>
